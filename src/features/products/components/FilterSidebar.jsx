      ...
      <div className="bg-navy-900 rounded-[2.5rem] p-8 border border-navy-800/50 sticky top-28 shadow-card space-y-10">
        <div>
          ...
          <div className="space-y-10">
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="flex-1 p-3 bg-navy-950 rounded-2xl border border-navy-800 text-right">
                    ...
                    <input
                      ...
                      className="w-full bg-transparent text-sm font-black text-white outline-none text-right"
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <h4 className="text-[10px] font-black text-brand-500 uppercase tracking-[0.2em]">Minimum Rating</h4>
              <select
                value={minRating}
                onChange={(e) => setMinRating(Number(e.target.value))}
                className="w-full bg-navy-950 border border-navy-800 py-3 px-4 rounded-2xl text-sm text-white outline-none focus:ring-2 focus:ring-brand-500/30"
              >
            ...
            <label className="flex items-center justify-between gap-4 cursor-pointer">
              ...
              <input
                ...
                className="h-5 w-5 cursor-pointer appearance-none rounded-lg border border-navy-800 bg-navy-950 transition-all checked:bg-brand-500 checked:border-brand-500 shadow-sm"
              />
            </label>
          </div>
        </div>
