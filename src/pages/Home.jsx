    ...
    <div className="bg-navy-950 overflow-hidden">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-24">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          {[
            {
              title: "Discrete Logistics",
              desc: "White-glove delivery service globally, ensuring your package arrives in pristine condition.",
              icon: "📦"
            },
            {
              title: "Bespoke Curation",
              desc: "Every item in our store is hand-vetted by industry experts for authenticity and craftsmanship.",
              icon: "💎"
            },
            {
              title: "Lifetime Support",
              desc: "A dedicated concierge is assigned to every member, available 24/7 for any request.",
              icon: "🤝"
            }
          ].map((item, i) => (
            <motion.div
